                      ...
                      if (code != null && code.isNotEmpty) {
                        ...
                        if (codeVal.containsKey("sectionid")) {
                          ...
                          if (widget.presectionList.isNotEmpty) {
                            for (SectionModel sectionModel
                                in widget.presectionList) {
                              if (sectionModel.id == sectionId && !isMainCall) {
                                isMainCall = true;
                                _camState = false;
                                setState(() {});
                                callMainScreen(
                                    sectionModel, codeVal["vendorid"]);
                              }
                            }
                          } else {
                            if (sectionConstantModel!.id != null &&
                                sectionConstantModel!.id == sectionId) {
                              if (allstoreList.isNotEmpty) {
                                ...
                                showAlertDialog(context, "Error".tr(),
                                    "You search on wrong section".tr(), true);
                              }
                            } else {
                              isMainCall = true;
                              _camState = false;
