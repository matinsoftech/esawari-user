      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Image.asset("assets/images/TAXI BOOKING.png"),
          ),
          Padding(
            padding: const EdgeInsets.only(left: 16, top: 32, right: 16, bottom: 8),
            child: Text(
              "Find Bike and Car near you",
          ...
          Padding(
            ...
            child: Text(
              "By allowing location access, you can search for Bike and Car near you and receive more accurate Service.",
